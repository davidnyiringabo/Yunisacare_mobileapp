...
const ShiftModule = ({hospital, date, address, time, payrate, accept})=>{
    return(
        <View style={styles.singleShiftContainer}>
            ...
            {accept && <TouchableOpacity style={{backgroundColor: "#000", width: "20%", height: 22, borderRadius: 3}}><Text style={{fontFamily: "Poppins-Light", color: "#FFF", fontSize: 10, paddingTop: 4,textAlign: "center"}}>accept <Image source={arrow}/> </Text></TouchableOpacity>}
        </View>
    )
}
